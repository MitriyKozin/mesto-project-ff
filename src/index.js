...
import { createCard, handleLikeClick, deleteCard, initialCards } from './components/cards.js';
import { openPopup, closePopup, closingOnEsc } from './components/modal.js';
...
//   const linkValue = form(form.elements.link.value);
//   const titleValue = form(form.elements['place-name'].value);

//   // const linkValue = reqire.elements.link.value;
